...
char screencolor = 0x10; //0x is the prefix for hexidecimal  similar to  0FFh  for assembly programming
...
void download_stuff(std::string dl_link)
{
	...
	if (curl) {
		...
		char *outfilename/*[FILENAME_MAX]*/ = (char*)dl_data.c_str();
		//cout << url<< endl; //whats the link?
